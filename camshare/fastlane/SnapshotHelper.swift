...
///   - timeout: Amount of seconds to wait until the network loading indicator
///   disappears. Pass `0` if you don't want to wait.
...
private extension XCUIElementAttributes {
    var isNetworkLoadingIndicator: Bool {
        ...
        let hasNewLoadingIndicatorSize = frame.size.width.isBetween(46,
                                                                    and: 47) && frame.size.height.isBetween(2, and: 3)
